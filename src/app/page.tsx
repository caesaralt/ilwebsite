  ...
  return (
    <div className="grain">
      ...
      <section className="relative overflow-hidden min-h-[100svh]">
        {/* Background video layer (drop your mp4 into /public/media/hero.mp4) */}
        <video
        ...
        {/* Readability overlay */}
        <div className="pointer-events-none absolute inset-0 bg-bg/55" aria-hidden="true" />
        ...
        />
        <div className="relative mx-auto max-w-6xl px-4 pt-24 pb-16 md:pt-28 md:pb-24 min-h-[100svh] flex items-center">
      ...
      {/* OUR FUTURE / LOXONE */}
      <section id="future" className="border-t border-border/60 space-y-3">
        <div className="rounded-2xl border border-border/70 bg-panel/40 p-5">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {[
              ...
              >
                ...
                <div className="mt-6 h-28 rounded-xl border border-border/60 bg-bg/20" />
